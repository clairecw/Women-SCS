...
<div class="jumbotron" style="background-image: url(https://www.women.cs.cmu.edu/test-site/wp-content/uploads/2018/04/alumni.jpg); background-position: 10% 25%">
  ...
  <div class="container">
      ...
      <div class="row">
        ...
        <div class="column-3">
          <a href="https://www.linkedin.com/groups/6720922/"><img class="hex" src="<?php echo get_template_directory_uri() . '/img/hex1.png';?>" /><br>
          LinkedIn Group</a>
        </div>
        <div class="column-3">
...
<center><h1>Some of Our Alumnae</h1></center>
<br>
<ul id="hexagons">
  <li class="pusher"></li>
	<li>
